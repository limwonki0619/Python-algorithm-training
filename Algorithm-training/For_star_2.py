...
def star():
    Height = int(input('Height 값은 33만 가능합니다.'))
    denominator = 4
    ...
    for P_3 in range(Height // denominator):  # Part_3
    ...
    for P_4 in reversed(range(Height // denominator)):  # Part_4
    ...
    for P_5 in reversed(range(Height // denominator)):    # Part_5
